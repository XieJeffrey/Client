...
namespace WindowFramework
{
    public class EventManager : Singleton<EventManager>
    {
        ...
        {
            public WindowFramework.MgrEventType eventType;
            public VoidHandle handle;
        }
        ...
        #region 管理器事件分发
        public void RegistEvent(WindowFramework.MgrEventType m_event, VoidHandle handle)
        {
        ...
        public void RemoveEvent(WindowFramework.MgrEventType m_event, VoidHandle handle)
        {
        ...
        public void NotifyEvent(WindowFramework.MgrEventType m_event, params object[] param)
        {
            for (int i = 0; i < mgrEventList.Count; i++)
            {
                if (mgrEventList[i].eventType == m_event)
